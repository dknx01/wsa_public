...
{
    #[Route('/')]
    public function index(WahlkreisRepository $wahlkreisRepo): Response
    {
        ...
        return $this->render(
            ...
            [
                ...
                'areas' => array_flip($wahlkreisRepo->getWahlkreiseFormatted()),
            ]
        );
    }
    ...
    #[Route('/ueberblick')]
    public function overview(StatisticRepository $repo): Response
    {
        $this->denyAccessUnlessGranted(ActiveUserVoter::ACTIVE_USER);
