    ...
    display(state, data) {
        ...
        if (data.length === 0) {
            ...
            for (let i = 0; i < data.length; i++) {
                html +=`<div class="statistic-status" id="statistic_status_${i}" data-id="${i}" data-area="${data[i].name}">${data[i].status}</div><div class="statistic-name" id="statistic_name_${i}" data-id="${i}" data-area="${ data[i].name }">${ data[i].name }</div>
